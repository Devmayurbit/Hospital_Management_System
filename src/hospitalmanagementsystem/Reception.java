 ...
 */
    public class Reception extends JFrame {
      Reception(){
          ...
          Image image  = i1.getImage().getScaledInstance(250,200,Image.SCALE_DEFAULT);
          ...
          label1.setBounds(980,50,300,100);
          panel1.add(label1);
          ...
          JButton btn5 = new JButton("Patients Info");
          ...
          btn10.setBackground(new Color(246,12,34));
          panel1.add(btn10);
